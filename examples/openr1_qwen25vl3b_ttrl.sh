#!/usr/bin/env bash
# open_r1 / mmr1 · qwen25vl3b · Qwen/Qwen2.5-VL-3B-Instruct · ttrl (unmaj, self-label majority-vote) · stack B (torch2.9/vllm0.11.2/tf4.57.0/ds0.18), ZeRO-3 (no offload).
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5,6,7}" accelerate launch \
    ...
    --num_processes 8 --main_process_port 19412 --gradient_accumulation_steps ${GA:-8} \
