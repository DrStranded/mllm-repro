#!/usr/bin/env bash
# open_r1, heter co-learn, A=Qwen/Qwen2.5-VL-7B-Instruct (flash_attention_2) x B=OpenGVLab/InternVL3_5-8B-HF (flash_attention_2)
...
# smoke: MAX_STEPS=1 MAX_SAMPLES=64 bash examples/phase4_heter_qwen25vl7b_x_internvl35_8b_openr1.sh
set -euo pipefail
...
TS="$(date +%Y%m%d_%H%M%S)"; RUN="phase4_heter_qwen25vl7b_x_internvl35_8b_openr1_${TS}"
